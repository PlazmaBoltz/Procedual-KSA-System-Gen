...
public class KSA_PSG_Functions
{
    ...
    private String[] systemPrefix = new string[] { "Alpha", "Beta", "Gamma", "Delta", "Epsilon", "Zeta", "Eta", "Theta", "Iota", "Kappa", "Lambda", "Mu", "Nu", "Xi", "Omicron", "Pi", "Rho", "Sigma", "Tau", "Upsilon", "Phi", "Chi", "Psi", "Omega", "Krieg", "Bob", "Kiwi", "Kosmina" };
    private String[] systemSuffix = new string[] { "Prime", "Secundus", "Tertius", "Quartus", "Quintus", "Sextus", "Septimus", "Octavus", "Nonus", "Decimus", "" };
    private String[] systemNumericPrefix = new string[] { "Kipler", "Gliese", "Ross", "Luyten", "Barnard", "Tiger", "Lacaille", "Struve", "Giclas", "Kapteyn", "Lalande", "van Biesbroeck", "WISE", "2KAT", "SSD", "Tomservo", "Hunter", "Polaris", "Banjo", "AMPW", "Lowne", "Hall", "Manley", "Jebadiah" };
